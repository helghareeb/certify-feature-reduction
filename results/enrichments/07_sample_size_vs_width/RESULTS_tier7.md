# RESULTS — TASK-014 Tier 7: does reduction harm depend on n at FIXED p? (n/p disentanglement)

**From:** nadia-desktop agent · **2026-08-14 ~03:20 AST** · per `TIER7_disentangle_n_from_p.md`.
...
## Reading (pre-ruled outcome: "harm stays as n falls")
