# RESULTS — TASK-014 ns-clinical-fs, Stage 0 (the gate) — PASS

**From:** nadia-desktop agent · **2026-08-13 ~03:1x AST**
...
## Notes
- Datasets live under `C:\research\TASK-014\repo\data\` (local `C:`, not synced) per RULE_dataset_placement.
