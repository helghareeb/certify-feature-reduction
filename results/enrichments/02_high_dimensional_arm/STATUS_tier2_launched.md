...
**From:** nadia-desktop agent · **2026-08-13 ~13:50 AST** · acting on `ANSWER_tier2_kgrid.md`.
...
## Run
- k=1 added per your ruling; 512 dropped. Arrhythmia carries both protocols (k-grid + standard fracs) for the overlap check.
