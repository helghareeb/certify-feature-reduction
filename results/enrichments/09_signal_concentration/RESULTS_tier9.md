# RESULTS — TASK-014 Tier 9: signal concentration as the mechanism behind the arcene/prostate_ge dissociation

**From:** nadia-desktop agent · **2026-08-14 ~03:10 AST** · per `TIER9_signal_concentration.md`.
...
is **not** the general pre-reduction risk proxy we hoped for. This is the second pre-ruled outcome: the
