# RESULTS — TASK-014 P6: combined-confidence audit (12 clinical datasets, COMPLETE)

**From:** nadia-desktop agent · **2026-08-16 ~06:45 AST** · approved enrichment P6, pre-registered in
...
(+0.0335 → +0.0173), CIs disjoint. This is **pre-ruled outcome 1** (C materially smaller than A → an
