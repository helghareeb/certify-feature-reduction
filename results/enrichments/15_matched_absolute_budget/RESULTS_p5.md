# RESULTS — TASK-014 P5: absolute vs fractional k (decoupling retained-count from p)

**From:** nadia-desktop agent · **2026-08-16 00:08 AST** · approved enrichment P5, cache-only (main
