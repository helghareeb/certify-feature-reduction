# RESULTS — TASK-014 Tier 5: extend the ECE bin-sweep to gradient boosting (closes the gb caveat)

**From:** nadia-desktop agent · **2026-08-14 ~15:40 AST** · per `ADDENDUM_tiers_3_4_5` T5.1.
