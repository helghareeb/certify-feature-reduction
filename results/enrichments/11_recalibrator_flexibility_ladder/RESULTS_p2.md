# RESULTS — TASK-014 P2: the recalibrator flexibility ladder (CORRECTED — matched all-ranker grid)

**From:** nadia-desktop agent · **2026-08-15 ~16:15 AST** · CORRECTED after the supervisor caught a
...
summary lives on the supervisor's box (from the 20-h all-rankers control). Corrected below on the matched
...
Independent check CONFIRMED on nadia-desktop: all-ranker none/sigmoid/isotonic ECE recomputed from the
