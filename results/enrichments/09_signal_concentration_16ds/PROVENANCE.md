...
**Received from nadia-desktop 2026-08-15, in response to `REQUEST_tier9_gli85.md`.**

## Why this folder exists separately

The original `results/tier9_from_nadia/` carries a `MANIFEST.sha256` that its author signed and that
...
| | |
|---|---|
| transport | `outbox/tier9_concentration_16ds_2026-08-15.zip` |
