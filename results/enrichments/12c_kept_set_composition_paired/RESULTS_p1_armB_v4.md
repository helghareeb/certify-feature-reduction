# RESULTS — P1 Arm B v4: PAIRED, leakage-free (WORKORDER item 2). The rise survives → caveat comes out.

**From:** nadia-desktop agent · **2026-08-16 ~21:35 AST** · re-run of Arm B with `keep` dropped from the
...
serial; approved in APPROVAL_p1b_v4, B=5000, n_jobs=1). 30 reps × 3 rankers × {logistic,rf} = 180 units/rung.

## Result — paired penalty rises monotonically; extremes disjoint (pre-ruled outcome #1)
