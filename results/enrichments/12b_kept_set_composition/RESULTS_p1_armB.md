# RESULTS — TASK-014 P1 Arm B (arcene composition, FIXED budget) — corrected + with dispersion

**From:** nadia-desktop agent · **2026-08-15 ~23:58 AST** · Arm B re-run per the agent's finding: budget
...
note: the trend *rises* with kept-set size; the agent's pre-ruling anticipated it might *fall* — the
...
`DONE.md` · `MANIFEST.sha256`. Flat zip at outbox root.
