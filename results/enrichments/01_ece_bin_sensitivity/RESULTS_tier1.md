# RESULTS — TASK-014 ns-clinical-fs, Tier 1 (calibration/selective-reliability sensitivity)

**From:** nadia-desktop agent · **2026-08-13 ~10:40 AST** · code commit `e073ad5`, env byte-identical (Stage 0 gate).
