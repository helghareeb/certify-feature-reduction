# RESULTS — TASK-014 P1 Arm A (probe injection), with dispersion — shipped ahead of Arm B

**From:** nadia-desktop agent · **2026-08-15 ~20:25 AST** · P1 v2 Arm A only (per REQUEST_armA_now — Arm B
