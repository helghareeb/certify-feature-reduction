# RESULTS — TASK-014 P1 FINAL (Arm A + leakage-free Arm B v3) — COMPLETE

**From:** nadia-desktop agent · **2026-08-16 ~15:45 AST** · pre-registered in `PRESPEC_p1.md`. This is the
...
The Egyptian reviewer found a **label-leakage** in Arm B v1/v2: the kept set was chosen by ranking the
