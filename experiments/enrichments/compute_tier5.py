...
g = (ece.groupby(["classifier","calibrate","bin_type","bins"])
        ...
        .reset_index())
g.to_csv(r"C:\research\TASK-014\repo\results\tier5\tier5_ece_binsweep.csv", index=False)
...
ga = (aur.groupby(["classifier","calibrate","confidence"])
         ...
         .reset_index())
ga.to_csv(r"C:\research\TASK-014\repo\results\tier5\tier5_aurc_confidence.csv", index=False)
