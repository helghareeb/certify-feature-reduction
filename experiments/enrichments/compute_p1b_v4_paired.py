...
(Egyptian agent REQUEST_three_final item 2 + Nadia: parallelise so it doesn't run on one core.)
...
def ci(v, seed=20260626, B=5000):  # 5000 to match stats.py BOOTSTRAP_DEFAULT (agent APPROVAL_p1b_v4)
